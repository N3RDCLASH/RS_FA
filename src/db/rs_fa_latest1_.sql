...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 18 mei 2020 om 03:11
...
INSERT INTO `taken` (`taak_id`, `project_id`, `naam`, `omschrijving`, `aantal`, `geschatteprijs`, `datum_start`, `datum_eind`) VALUES
(1, 3, 'Cupcakes Kopen', 'iem bai de san toh owru mang', 10, 200, NULL, NULL),
(2, 4, 'Kaarten schrijven', 'iem skrief den karta ', NULL, NULL, NULL, NULL),
(3, 3, 'Tent Opzetten', 'iem set a tenti \r\njwz!', NULL, NULL, NULL, NULL),
(4, 9, 'test', 'test', NULL, NULL, NULL, NULL),
(5, 9, 'test2', 'test2', NULL, NULL, NULL, NULL),
(6, 9, 'test3', 'test3', NULL, NULL, NULL, NULL),
(7, 9, 'test3', 'test3', NULL, NULL, NULL, NULL),
(8, 9, 'test3', 'test3', NULL, NULL, NULL, NULL),
(9, 9, 'test4', 'test4', NULL, NULL, NULL, NULL),
(10, 9, 'test5', 'test4', NULL, NULL, NULL, NULL),
(11, 9, 'test final', 'test4', NULL, NULL, NULL, NULL),
(12, 13, 'Een nieuwe taak', 'idk lol ', NULL, NULL, NULL, NULL),
(13, 5, 'Vuurwerk Kopen', 'ratatata', 2, 4000, NULL, NULL),
(14, 11, 'Spaghetti Koken', '5000 gram spaghetti koken', NULL, NULL, NULL, NULL),
(15, 14, 'New taak', 'gang shhhh', NULL, NULL, NULL, NULL),
(17, 12, 'trololol', 'memeLORD', NULL, NULL, NULL, NULL),
(18, 12, 'T’Challa', 'Wakanda Forever', NULL, NULL, NULL, NULL),
(19, 13, 'sdasd', 'asdas', NULL, NULL, NULL, NULL),
(20, 12, 'ss', 'ss', NULL, NULL, NULL, NULL),
(21, 14, 'kiwi', 'fruit', 1, 0, NULL, NULL),
(22, 14, 'pineapple', 'fruit', NULL, NULL, NULL, NULL),
(23, 6, 'Hark Kopen', 'xd', 4, 40, NULL, NULL),
(24, 11, 'houfhpsiof', 'KNEDPGSDOPGN', NULL, NULL, NULL, NULL),
(25, 12, 'manana', 'ssdads', NULL, NULL, NULL, NULL),
(26, 3, 'dfgere', 'tetetet ', NULL, NULL, NULL, NULL),
(27, 3, 'dfdf', 'dfsdf', NULL, NULL, NULL, NULL),
(28, 3, 'dasdasfd', 'dfgasdfd', NULL, NULL, NULL, NULL),
(29, 3, 'dasdasfddf32', 'dfgasdfd32', NULL, NULL, NULL, NULL),
(30, 3, 'ShivX', 'dfgasdfd32PR()N', NULL, NULL, NULL, NULL),
(31, 3, 'houfhpsiof', 'wewe', 0, 0, NULL, NULL),
(32, 17, 'Marktonderzoek doen', 'Onderzoeken mbv van een SWOT-analyse', NULL, NULL, NULL, NULL),
(33, 15, 'degpg-gj', 'sdsad', NULL, NULL, NULL, NULL),
(34, 18, 'Uitschrijven implementatie plan', 'Het uitschrijven van de stappen die ondernomen moeten worden', NULL, NULL, NULL, NULL);
